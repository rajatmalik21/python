...
from Browser_automation.locators.quotes_page_locators import QuotesPageLocators
from Browser_automation.parsers.quote import QuoteParser
    ...
    def search_for_quotes(self,author_name: str, tag_name: str) -> List[QuoteParser]:
        ...
        try:
            ...
            raise InvalidTagForAuthorError(
                f"Author `{author_name}` does not have any questions tagged with `{tag_name}`"
            )
